  ...
  return (
    <div className="w-screen h-full relative">
        ...
        <div className="absolute top-1/2 left-10 transform -translate-y-1/2 max-w-lg bg-gradient-to-r from-black/80 to-transparent  rounded-lg font-bold p-2">
            <h1 className="text-4xl bg-gradient-to-r from-white to-yellow-400 text-transparent bg-clip-text">{heading}</h1>
            <p className="mt-4 bg-gradient-to-r from-white to-yellow-400 text-transparent bg-clip-text">
              {text}
            </p>
